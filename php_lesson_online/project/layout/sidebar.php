 <div class="sidebar" data-color="rose" data-background-color="black" data-image="assets/img/sidebar-1.jpg">
  ...
  <div class="sidebar-wrapper">
   ...
   <ul class="nav">
    ...
    <!-- <li class="nav-item">
     <a class="nav-link"  href="2_variable_scope/corejs.php">
     ...
     <div class="collapse" id="pagesExamples">
      <ul class="nav">
       <li class="nav-item ">
        <a class="nav-link" href="2_variable_scope/1_local_variable.php">
         <span class="sidebar-mini"> l v </span>
         <span class="sidebar-normal"> local variable </span>
        </a>
       </li>
       <li class="nav-item ">
        <a class="nav-link" href="2_variable_scope/2_global_keyword.php">
         <span class="sidebar-mini"> RS </span>
         <span class="sidebar-normal"> Global Keyword </span>
        </a>
       </li>
       <li class="nav-item ">
       ...
       <li class="nav-item ">
        <a class="nav-link" href="examples/pages/error.html">
         ...
         <span class="sidebar-normal"> Error Page </span>5
        </a>
       </li>
       <li class="nav-item ">
        <a class="nav-link" href="examples/pages/error.html">
